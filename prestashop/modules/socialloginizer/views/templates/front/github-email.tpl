...
//$('#content').css('margin-top','23%');
	...
	#form{ width:98% !important; }
		...
		<div style=' padding: 10px;color: #000000;text-align: center;font-size: 20px;'>{l s=' Login with Github' mod='socialloginizer'}</div>
    <section  style='text-align:-moz-center;'>
        <form method="post" name="loginizer_emailform" id="form" style ="padding: 10px;border: 1px solid #ccc;
            ...
            <div style=" padding: 15px;border-radius: 4px;box-sizing: border-box;color: #FFFFFF;text-align: justify;margin-bottom: 20px;line-height: 1.4;background-color: #829aa8;font-size: 14px;">
                    {l s='Enter your Github Email id in order to proceed...' mod='socialloginizer'}
            </div>
		<div style="float:left;width:100%;">
                ...
                <input type='submit' value='{l s='Proceed' mod='socialloginizer'}' class='btn btndefault' name='snslogin_email' style='cursor: pointer;width: 100%;color: #000000;font-size: 17px;background-color: #ddd;margin-top: 5px;border-radius: 3px;border: 1px solid #740C8D;border-color: #ccc;background-image: linear-gradient(#eee, #ddd);'/>
			</div><div style="clear: both"></div><div style='  text-align: center;position: relative;top: 10px;'><img src="{$modulepath|escape:'htmlall':'UTF-8'}socialloginizer/views/img/github-icon.png"></div></div> </form>
    </section>
</div>
{*
* DISCLAIMER
